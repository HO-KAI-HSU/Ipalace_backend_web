  ...
  <div>
    ...
    >
      <div class="card-body">
        ...
        <div class="form-group">
          <label>啟用</label>
          <select class="form-control" v-model="currentItem.Active">
  ...
  methods: {
    ...
    async loadBanner() {
      ...
      var cols = [
        ...
        //    return `<input class="form-control document-sort" type="number" value="${data}" data-id="${row["BannerID"]}"/>`;
        //  },
        //},
        {
          title: "#",
    ...
    async mlDialogOK(e) {
      ...
      try {
        if (this.currentItem.BannerID) {
          await this.$api.updateBanner(this.currentItem);
        } else {
